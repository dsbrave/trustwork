...
export function MegaMenuPostJob() {
  const t = useTranslations("MegaMenuHire");
  const tLanding = useTranslations("Landing");
  const messages = useMessages();
  const mm = messages.MegaMenuHire as Record<string, string>;
            ...
            <div className="absolute left-0 top-full z-[201] pt-2">
              ...
              >
                <div className="grid grid-cols-4 gap-x-10 gap-y-10 p-8 lg:gap-x-8">
                  {PROFESSION_MEGA_MENU_HIRE.map((column, ci) => (
